...
import pyceph.utils as utils
from pyceph.Landmarks import Landmarks
from pyceph.ConsoleMsg import ConsoleMsg
from pyceph.ModelWrapper import ModelWrapper
...
class CephImage:
  ...
  def save_landmarks_to_jpg_and_csv(self):
    ...
    # This function is bypassed in web version
      pass

    # Skip ConsoleMsg.print_terminate() in web usage
